// Test script to call The Campaign Registry (TCR) API directly
// This bypasses the Supabase Edge Function to test if the issue is with the proxy
...
async function testTCRDirect() {
  try {
    console.log("🚀 Testing TCR API Direct Call...");
    console.log("📋 Brand Data:", JSON.stringify(testBrandData, null, 2));
    console.log("🔑 Using TCR Staging Environment");
    console.log("🌐 URL:", `${TCR_BASE_URL}/v2/brands`);
    ...
    console.log("✅ TCR Direct Response:", JSON.stringify(result, null, 2));
    ...
    console.error("💥 Direct TCR test failed:", error.message);
    console.error("Stack trace:", error.stack);
  }
}

// Test the API directly
testTCRDirect().catch(console.error); 